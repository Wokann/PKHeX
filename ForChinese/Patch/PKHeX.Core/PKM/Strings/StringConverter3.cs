...
[GEN123_EN]
    ...
    private const byte TableMax = 0x1E;
...
[GEN123_EN]
    ...
    public static int LoadString(ReadOnlySpan<byte> data, Span<char> result, int language)
    {
        ...
        for (; i < data.Length; i++)
        {
            ...
            var c = value switch
            {
                ...
                _ when value >= TableMin && value <= TableMax &&
                       value != 0x06 && value != 0x1B &&
                       language != (int)LanguageID.Japanese =>
                       (i + 1 >= data.Length) ? table[value] : GetTable(value)[data[++i]],
                _ => table[value],
            }; // Convert to Unicode
    ...
    public static int SetString(Span<byte> buffer, ReadOnlySpan<char> value, int maxLength, int language, StringConverterOption option = StringConverterOption.ClearFF)
    {
        ...
        {
            var (table2, val) = GetChineseChar(c);
            if (table2 != TableInvalid && !jp)
            {
...
[GEN123_EN]
    ...
    private static  ReadOnlySpan<char> G3_CHN_01 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_02 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_03 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_04 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_05 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_07 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_08 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_09 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_0A =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_0B =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_0C =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_0D =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_0E =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_0F =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_10 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_11 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_12 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_13 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_14 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_15 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_16 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_17 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_18 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_19 =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_1A =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_1C =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_1D =>
    [
    ...
    private static  ReadOnlySpan<char> G3_CHN_1E =>
    [
        ...
        '冴', '広', Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator, Terminator,
